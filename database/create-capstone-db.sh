...
psql -U postgres -d capstone -f "$BASEDIR/sample-buyer-information-development.sql" &&
...
psql -U postgres -d capstone -f "$BASEDIR/items-development.sql" &&
psql -U postgres -d capstone -f "$BASEDIR/invoice-development.sql" &&
psql -U postgres -d capstone -f "$BASEDIR/harvest-details-development.sql" &&
psql -U postgres -d capstone -f "$BASEDIR/invoice-items-development.sql"
